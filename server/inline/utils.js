...
const KEY = 'c9e3909e0bd54e9e9b0c1328a4eb01f4'
const USER_ID = 'HE1809111701541892'
const WECHAT_APPID = 'wx716ad089419b8068'
const WECHAT_APP_SECRET = 'e6c415cb24a9af12c6cc1b777e366287'

/*<remove trigger="prod">*/
const STATIC_SERVER_URL = `http://192.168.1.104:3000/static`
/*</remove>*/
...
const $ = {
  ...
  airBackgroundColor: aqi => {
    if (aqi < 50) return '#00cf9a'
    else if (aqi < 100) return '#4295f4'
    else if (aqi < 200) return '#ff6600'
  ...
  handlerData: data => {
    console.log(5, data.HeWeather6[0].now)
